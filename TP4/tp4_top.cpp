...
int _main (int argc, char * argv[]) {
    ...
    size_t icache_ways   = 4; // instruction cache number of ways
    size_t icache_sets   = 256; // instruction cache number of sets
    size_t icache_words  = 16; // instruction cache number of words per line
    size_t dcache_ways   = 1; // data cache number of ways
    size_t dcache_sets   = 1; // data cache number of sets
    size_t dcache_words  = 8; // data cache number of words per line
    ...
    soclib::common::Loader loader(sys_path, app_path);    
